...
namespace LINQToSQL.CookiesDataSetTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, Phone FROM Customer WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::LINQToSQL.Properties.Settings.Default.CookiesConnectionString;
        }
    ...
    public partial class OrderTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Order] ([OrderID], [CustomerID], [OrderDate], [OrderQuantity])" +
                ...
                "stomerID, OrderDate, OrderQuantity FROM [Order] WHERE (OrderID = @OrderID)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
...
SELECT OrderID, CustomerID, OrderDate, OrderQuantity FROM [Order] WHERE (OrderID = @OrderID)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
