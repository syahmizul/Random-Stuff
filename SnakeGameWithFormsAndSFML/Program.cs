...
namespace SnakeGameWithFormsAndSFML
{
    static class Program
    {
        static void Main()
        {
            ...
            // initialize sfml
            RenderWindow renderwindow = new RenderWindow(rendersurface.Handle); // creates our SFML RenderWindow on our surface control
            ...
            while (form.Visible) // loop while the window is open
            {
                ...
                renderwindow.Clear(Color.Yellow); // clear our SFML RenderWindow
