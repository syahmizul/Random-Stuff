...
namespace DetailsDatabase {
    ...
    public partial class CookiesDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomerRow AddCustomerRow(string CustomerID, string CompanyName, string ContactName, string Phone) {
        ...
        public partial class OrderDataTable : global::System.Data.TypedTableBase<OrderRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public OrderRow AddOrderRow(int OrderID, CustomerRow parentCustomerRowByFK_Order_Customer, System.DateTime OrderDate, int OrderQuantity) {
...
namespace DetailsDatabase.CookiesDataSetTableAdapters {
...
SELECT CustomerID, CompanyName, ContactName, Phone FROM Customer WHERE (CustomerID = @CustomerID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DetailsDatabase.Properties.Settings.Default.CookiesConnectionString;
        }
        ...
        public virtual int Fill(CookiesDataSet.CustomerDataTable dataTable) {
        ...
        public virtual CookiesDataSet.CustomerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CookiesDataSet.CustomerDataTable dataTable = new CookiesDataSet.CustomerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CookiesDataSet.CustomerDataTable dataTable) {
    ...
    public partial class OrderTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Order] WHERE (([OrderID] = @Original_OrderID) AND ([CustomerID] = @Original_CustomerID) AND ((@IsNull_OrderDate = 1 AND [OrderDate] IS NULL) OR ([OrderDate] = @Original_OrderDate)) AND ((@IsNull_OrderQuantity = 1 AND [OrderQuantity] IS NULL) OR ([OrderQuantity] = @Original_OrderQuantity)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Order] ([OrderID], [CustomerID], [OrderDate], [OrderQuantity])" +
                " VALUES (@OrderID, @CustomerID, @OrderDate, @OrderQuantity);\r\nSELECT OrderID, Cu" +
                "stomerID, OrderDate, OrderQuantity FROM [Order] WHERE (OrderID = @OrderID) ORDER" +
                " BY OrderDate";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
...
SELECT OrderID, CustomerID, OrderDate, OrderQuantity FROM [Order] WHERE (OrderID = @OrderID) ORDER BY OrderDate";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT OrderID, CustomerID, OrderDate, OrderQuantity FROM dbo.[Order]\r\nWHERE Orde" +
                "rQuantity > 100\r\nORDER BY OrderDate";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
